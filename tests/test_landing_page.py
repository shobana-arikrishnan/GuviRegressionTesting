...
class TestLandingPage:
    ...
    def test_footer_text(self, landing_page):
        assert (landing_page.get_footer_text().is_displayed())

    def test_signup_link(self, landing_page):
        time.sleep(5)
    ...
    def test_courses_link(self, landing_page):
        landing_page.browse()
        time.sleep(5)
    ...
    def test_login_link(self, landing_page):
        landing_page.browse()
        time.sleep(10)
