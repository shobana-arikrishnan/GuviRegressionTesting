...
class GuviCoursesPageAfterLogin():
    ...
    def get_course_library_link(self):
        return self.driver.find_element(by=By.LINK_TEXT, value=self.course_library_link_locator)

    def get_combo_link(self):
        return self.driver.find_element(by=By.LINK_TEXT, value=self.combo_link_locator)

    def get_free_library_link(self):
        return self.driver.find_element(by=By.LINK_TEXT, value=self.free_library_link_locator)

    def get_my_courses_link(self):
        return self.driver.find_element(by=By.LINK_TEXT, value=self.my_courses_link_locator)

    def get_zen_link(self):
        return self.driver.find_element(by=By.LINK_TEXT, value=self.zen_link_locator)
    ...
    def get_debugging_link(self):
        return self.driver.find_element(by=By.ID, value=self.debugging_link_locator)
    ...
    def get_forum_link(self):
        return self.driver.find_element(by=By.XPATH, value=self.forum_link_locator)
