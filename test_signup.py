def test_signup_title(signup_page):
    assert (signup_page.get_title()) == 'GUVI | Sign-up'


def test_logo(signup_page):
    assert (signup_page.get_logo().is_displayed())


def test_google_signin(signup_page):
    assert (signup_page.get_google_signin().is_displayed())


def test_signup_success(signup_info, signup_page):
...
def test_signup_failed(signup_failed_info, signup_page):
