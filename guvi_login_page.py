...
class GuviLoginPage():
    ...
    def clear_login_form(self):
        self.driver.find_element(by=By.ID, value=self.email_locator).clear()
        self.driver.find_element(by=By.ID, value=self.password_locator).clear()
    ...
    def get_warning(self):
        return (
            self.driver.find_element(by=By.ID, value="email_warn"),
            self.driver.find_element(by=By.ID, value='pass_warn')
        )
